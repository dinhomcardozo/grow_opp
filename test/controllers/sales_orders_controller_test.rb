...
class SalesOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sales_order" do
    assert_difference("SalesOrder.count") do
      post sales_orders_url, params: { sales_order: { opportunity_id: @sales_order.opportunity_id, total_price: @sales_order.total_price } }
    end
  ...
  test "should update sales_order" do
    patch sales_order_url(@sales_order), params: { sales_order: { opportunity_id: @sales_order.opportunity_id, total_price: @sales_order.total_price } }
