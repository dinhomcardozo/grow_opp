...
class StagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stage" do
    assert_difference("Stage.count") do
      post stages_url, params: { stage: { stage_name: @stage.stage_name, status: @stage.status } }
    end
  ...
  test "should update stage" do
    patch stage_url(@stage), params: { stage: { stage_name: @stage.stage_name, status: @stage.status } }
