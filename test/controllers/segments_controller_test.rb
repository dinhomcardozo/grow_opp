...
class SegmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create segment" do
    assert_difference("Segment.count") do
      post segments_url, params: { segment: { segment_name: @segment.segment_name, status: @segment.status } }
    end
  ...
  test "should update segment" do
    patch segment_url(@segment), params: { segment: { segment_name: @segment.segment_name, status: @segment.status } }
